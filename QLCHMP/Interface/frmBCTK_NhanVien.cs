...
namespace QLCHMP.Interface
{
    public partial class frmBCTK_NhanVien : Form
    {
        ...
        private void btnHienThi_Click(object sender, EventArgs e)
        {
            ...
            SqlConnection cn = new SqlConnection(@"data source = LAPTOP-0TC4M5HB\\SQLEXPRESS;initial catalog=ql_chmt;integrated security=true");
            ...
            catch (Exception ex)
            {
                ...
                Console.WriteLine("err_HienThi: " + ex.Message);
            }
        }
    }
}
